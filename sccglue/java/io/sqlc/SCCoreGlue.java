...
public class SCCoreGlue {
  ...
  /** Interface to C language function: <br> <code> int scc_bind_text_utf16_bytes(int connection_id, int index, void *  text, int length); </code>    */
  public static native int scc_bind_text_utf16_bytes(int connection_id, int index, String text, int length);

  /** Interface to C language function: <br> <code> int scc_bind_text_utf8_bytes(int connection_id, int index, void *  text, int length); </code>    */
  public static native int scc_bind_text_utf8_bytes(int connection_id, int index, String text, int length);
