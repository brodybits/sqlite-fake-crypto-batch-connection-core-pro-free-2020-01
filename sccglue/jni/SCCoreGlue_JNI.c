/* !---- DO NOT EDIT: This file autogenerated by com/jogamp/gluegen/JavaEmitter.java on Mon Jun 15 19:05:02 EDT 2020 ----! */
...
/*   Java->C glue code:
 *   Java package: io.sqlc.SCCoreGlue
 *    Java method: int scc_bind_text_utf8_bytes(int connection_id, int index, java.lang.String text, int length)
 *     C function: int scc_bind_text_utf8_bytes(int connection_id, int index, void *  text, int length);
 */
JNIEXPORT jint JNICALL
Java_io_sqlc_SCCoreGlue_scc_1bind_1text_1utf8_1bytes__IILjava_lang_String_2I(JNIEnv *env, jclass _unused, jint connection_id, jint index, jstring text, jint length) {
  const char* _strchars_text = NULL;
  int _res;
  if ( NULL != text ) {
    _strchars_text = (*env)->GetStringUTFChars(env, text, (jboolean*)NULL);
  if ( NULL == _strchars_text ) {
      (*env)->ThrowNew(env, (*env)->FindClass(env, "java/lang/OutOfMemoryError"),
                       "Failed to get UTF-8 chars for argument \"text\" in native dispatcher for \"scc_bind_text_utf8_bytes\"");
      return 0;
    }
  }
  _res = scc_bind_text_utf8_bytes((int) connection_id, (int) index, (void *) _strchars_text, (int) length);
  if ( NULL != text ) {
    (*env)->ReleaseStringUTFChars(env, text, _strchars_text);
  }
  return _res;
...
/*   Java->C glue code:
 *   Java package: io.sqlc.SCCoreGlue
 *    Java method: int scc_key(int connection_id, java.lang.String key)
 *     C function: int scc_key(int connection_id, const char *  key);
 */
JNIEXPORT jint JNICALL
Java_io_sqlc_SCCoreGlue_scc_1key__ILjava_lang_String_2(JNIEnv *env, jclass _unused, jint connection_id, jstring key) {
  const char* _strchars_key = NULL;
  int _res;
  if ( NULL != key ) {
    _strchars_key = (*env)->GetStringUTFChars(env, key, (jboolean*)NULL);
  if ( NULL == _strchars_key ) {
      (*env)->ThrowNew(env, (*env)->FindClass(env, "java/lang/OutOfMemoryError"),
                       "Failed to get UTF-8 chars for argument \"key\" in native dispatcher for \"scc_key\"");
      return 0;
    }
  }
  _res = scc_key((int) connection_id, (char *) _strchars_key);
  if ( NULL != key ) {
    (*env)->ReleaseStringUTFChars(env, key, _strchars_key);
  }
  return _res;
}
